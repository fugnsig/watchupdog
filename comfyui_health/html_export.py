...
<title>ComfyUI Health — {_esc(build_name or "Report")} — {_esc(status_str)}</title>
<style>{_CSS}</style>
</head>
<body>
...
<footer>Generated by comfyui-health &nbsp;|&nbsp; {_esc(report.timestamp)}</footer>
</body>
</html>"""
